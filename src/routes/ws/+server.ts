// WebSocket mock server for development - handles real-time tile updates

import { WebSocketServer } from 'ws';
import type { WSMessage, PixelUpdate } from '../../lib/types.js';
...
if (import.meta.env.DEV) {
	wsServer = new GameWSServer();
}

// SvelteKit server route handler (for production)
